Lvduit.Routers.AdminRouter = Backbone.Router.extend({
    routes: {
        "": "home",
    ...
    initialize: function() {
        this.sidebarView = new Lvduit.Views.Sidebar({el: $('#sidebar')});
    ...
    newArticle: function() {
        this.newArticle = new Lvduit.Views.NewArticle();
    ...
    articleEdition: function(id) {
        ...
        this.articleEditionView = new Lvduit.Views.Edition();
    ...
    userEdition: function(id) {
        ...
        this.userEditionView = new Lvduit.Views.Edition(app);
